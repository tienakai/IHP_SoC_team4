set ::env(PDN_CFG) /nix/store/4lnizdcfpwncfgmyqhj7a0vd92nr2swy-python3.13-librelane-3.1.0.dev3/lib/python3.13/site-packages/librelane/scripts/openroad/common/pdn_cfg.tcl
...
set ::env(DESIGN_NAME) serial2parallel
set ::env(CLOCK_PERIOD) 20.0
set ::env(CLOCK_PORT) clk
set ::env(VDD_NETS) VDD
set ::env(GND_NETS) VSS
set ::env(DIE_AREA) "0.0 0.0 540.0 200.0"
set ::env(FALLBACK_SDC) /nix/store/4lnizdcfpwncfgmyqhj7a0vd92nr2swy-python3.13-librelane-3.1.0.dev3/lib/python3.13/site-packages/librelane/scripts/base.sdc
set ::env(PAD_LIBS) ""
...
set ::env(PAD_SPICE_MODELS) /opt/pdks/ihp-sg13g2/libs.ref/sg13g2_io/spice/sg13g2_io.spice
...
set ::env(CURRENT_ODB) /home/designer/shared/s2p/runs/RUN_2026-09-12_02-16-42/19-openroad-tapendcapinsertion/serial2parallel.odb
set ::env(SAVE_ODB) /home/designer/shared/s2p/runs/RUN_2026-09-12_02-16-42/21-openroad-generatepdn/serial2parallel.odb
set ::env(SAVE_DEF) /home/designer/shared/s2p/runs/RUN_2026-09-12_02-16-42/21-openroad-generatepdn/serial2parallel.def
set ::env(SAVE_SDC) /home/designer/shared/s2p/runs/RUN_2026-09-12_02-16-42/21-openroad-generatepdn/serial2parallel.sdc
set ::env(SAVE_NL) /home/designer/shared/s2p/runs/RUN_2026-09-12_02-16-42/21-openroad-generatepdn/serial2parallel.nl.v
set ::env(SAVE_PNL) /home/designer/shared/s2p/runs/RUN_2026-09-12_02-16-42/21-openroad-generatepdn/serial2parallel.pnl.v
